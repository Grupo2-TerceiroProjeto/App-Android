...
class AdminApiViewModel(private val api: AdminRepository, override val sessaoUsuario: UserSession) :
    ...
    override fun salvarFuncionario(
        funcionario: RegisterCreateModel,
        onBack: () -> Unit,
        onSucess: () -> Unit
    ) {
